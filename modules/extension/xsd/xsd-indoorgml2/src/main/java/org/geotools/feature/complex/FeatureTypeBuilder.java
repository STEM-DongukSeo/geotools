...
public class FeatureTypeBuilder {
    ...
    //
    public FeatureTypeBuilder(FeatureTypeFactory factory) {
...
//    }
    ...
    public FeatureTypeBuilder name(String name) {
        setName(name);
        return this;
    }
    ...
    public FeatureTypeBuilder bind(Class<?> binding) {
        setBinding(binding);
        return this;
    }
     ...
     */
    public FeatureTypeBuilder property(PropertyType type) {
    ...
    public FeatureTypeBuilder nillable(boolean isNillable) {
    ...
    public FeatureTypeBuilder cardinality(int min, int max) {
        this.minOccurs = min;
        this.maxOccurs = max;
        return this;
    }
     ...
     */
    public FeatureTypeBuilder attribute(String name, Class binding) {
     ...
     * @return this builder for additional chaining
     */
    public FeatureTypeBuilder attribute(String namespaceURI, String name, Class binding) {
        return attribute(createName(namespaceURI, name), binding);
    }

    public FeatureTypeBuilder attribute(Name name, Class binding) {
        return attribute(name, getBinding(binding));
    }

    public FeatureTypeBuilder attribute(String name, String namespaceURI, AttributeType type) {
        attribute(createName(namespaceURI, name), type);
        return this;
    }

    public FeatureTypeBuilder attribute(String name, AttributeType type) {
        attribute(name, getNamespaceURI(), type);
        return this;
    }

    public FeatureTypeBuilder attribute(Name name, AttributeType type) {
        // TODO: handle default value
    ...
    public FeatureTypeBuilder referenceType(AttributeType reference) {
    ...
    public FeatureTypeBuilder association(String name, AssociationType type) {
        return association(getNamespaceURI(), name, type);
    }

    public FeatureTypeBuilder association(String namespaceURI, String name, AssociationType type) {
        return association(createName(namespaceURI, name), type);
    }

    public FeatureTypeBuilder association(Name name, AssociationType type) {
     ...
     * </p>
     */
    public FeatureTypeBuilder add(PropertyDescriptor descriptor) {
    ...
    public FeatureTypeBuilder defaultGeometry(String name) {
    ...
    public FeatureTypeBuilder crs(CoordinateReferenceSystem crs) {
        setCRS(crs);
        return this;
    }
     ...
     */
    public FeatureTypeBuilder crs(String SRS) {
        try {
     ...
     */
    public FeatureTypeBuilder member(String name, AssociationType type) {
     ...
     * @return TypeBuilder for operation chaining
     */
    public FeatureTypeBuilder member(Name name, AssociationType type) {
        AssociationDescriptor descriptor = getTypeFactory().createAssociationDescriptor(type, name,
                getMinOccurs(), getMaxOccurs(), isNillable());
        clear();
    ...
    public FeatureTypeBuilder member(AssociationDescriptor memberOf) {
