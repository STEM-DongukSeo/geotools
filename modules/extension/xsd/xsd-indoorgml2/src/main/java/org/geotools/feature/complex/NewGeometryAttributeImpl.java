 ...
 * @source $URL$
 */
public class NewGeometryAttributeImpl extends AttributeImpl implements
		GeometryAttribute {
	/**
	 * bounds, derived
	 */
	...
	public NewGeometryAttributeImpl( Object content, GeometryDescriptor descriptor, Identifier id ) {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof NewGeometryAttributeImpl)) {
			return false;
		}
		
		NewGeometryAttributeImpl att = (NewGeometryAttributeImpl) o;
