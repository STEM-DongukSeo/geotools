 ...
 */
public abstract class NewGeometryFilterImpl extends BinaryComparisonAbstract
    ...
    @Deprecated
    protected NewGeometryFilterImpl() throws IllegalFilterException {
    }

    protected NewGeometryFilterImpl(MatchAction matchAction) {
        this.matchAction = matchAction;
    }

    protected NewGeometryFilterImpl(org.opengis.filter.expression.Expression e1,
            org.opengis.filter.expression.Expression e2, MatchAction matchAction) {
        super(e1, e2);
        this.matchAction = matchAction;
    }

    protected NewGeometryFilterImpl(org.opengis.filter.FilterFactory factory) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof NewGeometryFilterImpl) {
            NewGeometryFilterImpl geomFilter = (NewGeometryFilterImpl) obj;
