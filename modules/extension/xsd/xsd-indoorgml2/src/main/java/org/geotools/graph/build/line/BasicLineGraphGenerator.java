...
public class BasicLineGraphGenerator implements LineGraphGenerator {
  ...
  public BasicLineGraphGenerator () {
    ...
    pf = new PrimitiveFactoryImpl(null);
  ...
  protected LineSegment alterLine(LineSegment line, Node n1, Node n2) {
      ...
      if (!c1added.equals(line.getStartPoint()) || c2added.equals(line.getEndPoint())) {
        return new LineSegmentImpl(c1added,c2added,0);
      }
      return line;
  }
  ...
  private Node findClosestNodeWithinTolerance(DirectPosition inCoord) {
    ...
    List<DirectPosition> list = spatialIndex.query(new Interval(inCoord.y - tolerance, inCoord.y + tolerance));
    for (DirectPosition c : list) {
      double distance = inCoord.(c);
