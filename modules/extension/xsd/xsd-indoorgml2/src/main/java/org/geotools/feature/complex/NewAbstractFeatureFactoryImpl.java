 ...
 * @version $Id$
 */
public abstract class NewAbstractFeatureFactoryImpl implements FeatureFactory {
	...
	public GeometryAttribute createGeometryAttribute(
		...
		return new NewGeometryAttributeImpl(value,descriptor, id == null? null : ff.gmlObjectId(id));
	}
