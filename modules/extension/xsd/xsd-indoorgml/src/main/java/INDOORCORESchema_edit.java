...
import org.geotools.feature.type.AbstractLazyFeatureTypeImpl;
...
public class INDOORCORESchema_edit extends SchemaImpl {
     ...
     * @generated
     */
    public static final FeatureType CELLSPACEBOUNDARYTYPE_TYPE = build_CELLSPACEBOUNDARYTYPE_TYPE();
    
    private static FeatureType build_CELLSPACEBOUNDARYTYPE_TYPE() {
    	FeatureType builtType = new AbstractLazyFeatureTypeImpl(
    ...
    public static void main(String[] args) {
        Schema schema = new INDOORCORESchema_edit();
