 ...
 * @source $URL$
 */
public class AssociationTypeBuilder {
	 ...
	 * 
	 */
	public AssociationTypeBuilder( FeatureTypeFactory factory ) {
	...
	public AssociationTypeBuilder setFactory(FeatureTypeFactory factory) {
		this.factory = factory;
		return this;
	}
	 ...
	 */
	public AssociationTypeBuilder init( AttributeType type ) {
	...
	public AssociationTypeBuilder binding(Class binding) {
		setBinding(binding);
		return this;
	}

	public AssociationTypeBuilder name(String name) {
		setName(name);
		return this;
	}

	public AssociationTypeBuilder namespaceURI(String namespaceURI) {
		setNamespaceURI(namespaceURI);
		return this;
		
	}
	
	public AssociationTypeBuilder crs(CoordinateReferenceSystem crs) {
		setCRS(crs);
	    return this;
	}

	public AssociationTypeBuilder description(String description) {
		setDescription(description);
		return this;
	}

	public AssociationTypeBuilder abstrct(boolean isAbstract) {
		setAbstract(isAbstract);
		return this;
	}

	public AssociationTypeBuilder identifiable(boolean isIdentifiable) {
		setIdentifiable(isIdentifiable);
		return this;
	}

	public AssociationTypeBuilder length( int length ) {
	    setLength(length);
	    return this;
	}
	
	public AssociationTypeBuilder restriction(Filter restriction) {
	...
	public AssociationTypeBuilder nillable(boolean isNillable) {
		setNillable(isNillable);
		return this;
	}

	public AssociationTypeBuilder maxOccurs(int maxOccurs) {
		setMaxOccurs(maxOccurs);
		return this;
	}

	public AssociationTypeBuilder minOccurs(int minOccurs) {
		setMinOccurs(minOccurs);
		return this;
	}
	
	public AssociationTypeBuilder defaultValue(Object defaultValue) {
		setDefaultValue(defaultValue);
		return this;
	}
	
	public AssociationTypeBuilder userData( Object key, Object value ) {
