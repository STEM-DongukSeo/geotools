...
public class NewTypeBuilder {
    ...
    //
    public NewTypeBuilder(FeatureTypeFactory factory) {
        this.factory = factory;
        init();
    }

    public NewTypeBuilder() {
...
//    }
    ...
    public NewTypeBuilder name(String name) {
        setName(name);
        return this;
    }
    ...
    public NewTypeBuilder bind(Class<?> binding) {
        setBinding(binding);
        return this;
    }
     ...
     */
    public NewTypeBuilder property(PropertyType type) {
    ...
    public NewTypeBuilder nillable(boolean isNillable) {
    ...
    public NewTypeBuilder cardinality(int min, int max) {
        this.minOccurs = min;
        this.maxOccurs = max;
        return this;
    }
     ...
     */
    public NewTypeBuilder attribute(String name, Class binding) {
     ...
     * @return this builder for additional chaining
     */
    public NewTypeBuilder attribute(String namespaceURI, String name, Class binding) {
        return attribute(createName(namespaceURI, name), binding);
    }

    public NewTypeBuilder attribute(Name name, Class binding) {
        return attribute(name, getBinding(binding));
    }

    public NewTypeBuilder attribute(String name, String namespaceURI, AttributeType type) {
        attribute(createName(namespaceURI, name), type);
        return this;
    }

    public NewTypeBuilder attribute(String name, AttributeType type) {
        attribute(name, getNamespaceURI(), type);
        return this;
    }

    public NewTypeBuilder attribute(Name name, AttributeType type) {
        // TODO: handle default value
    ...
    public NewTypeBuilder referenceType(AttributeType reference) {
    ...
    public NewTypeBuilder association(String name, AssociationType type) {
        return association(getNamespaceURI(), name, type);
    }

    public NewTypeBuilder association(String namespaceURI, String name, AssociationType type) {
        return association(createName(namespaceURI, name), type);
    }

    public NewTypeBuilder association(Name name, AssociationType type) {
     ...
     * </p>
     */
    public NewTypeBuilder add(PropertyDescriptor descriptor) {
    ...
    public NewTypeBuilder defaultGeometry(String name) {
    ...
    public NewTypeBuilder crs(CoordinateReferenceSystem crs) {
        setCRS(crs);
        return this;
    }
     ...
     */
    public NewTypeBuilder crs(String SRS) {
        try {
     ...
     */
    public NewTypeBuilder member(String name, AssociationType type) {
     ...
     * @return TypeBuilder for operation chaining
     */
    public NewTypeBuilder member(Name name, AssociationType type) {
        AssociationDescriptor descriptor = getTypeFactory().createAssociationDescriptor(type, name,
                getMinOccurs(), getMaxOccurs(), isNillable());
        clear();
    ...
    public NewTypeBuilder member(AssociationDescriptor memberOf) {
