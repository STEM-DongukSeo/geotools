...
public class SFWrapperTest extends TestCase {
    ...
    public void _testSFPoint() {
        ...
        p.setM(2.5);
        /*
         * System.out.println("x : " + p.x()); System.out.println("y : " + p.y()); System.out.println("z : " + p.z()); System.out.println("m : " +
         * p.m()); System.out.println("dimension : " + p.dimension()); System.out.println("coordinateDimension : " + p.coordinateDimension());
         * System.out.println("wkt : " + p.asText(1)); System.out.println("p == p2 ? " + p.equals(p2));
         */
    ...
    public void _testSFLineString() {
        ...
        /*
         * System.out.println("coodinateDemension : " + ls.pointN(2).coordinateDimension());
         * System.out.println("demension : " + ls.pointN(2).dimension());
         * System.out .println("ls numpoins : " + ls.numPoints() + " numsegments : " + ls.numSegments());
         */
    ...
    public void _testSFPolyhedralSurface() {
        ...
        System.out.println("PolyhedralSurface boundary.toString() : "
                + polyhedral.boundary().asText(0));
    ...
    public static void _testSFSolid() {
        ...
        System.out.println("solid1.geometryType() : " + solid.geometryType());
        System.out.println("solid1.geometryTypeId() : " + solid.geometryTypeId());
        System.out.println("solid1.numGeometries() : " + solid.numGeometries());
        System.out.println("solid1.numInteriorShells() : " + solid.numInteriorShells());
        System.out.println("solid1.numShells() : " + solid.numShells());
