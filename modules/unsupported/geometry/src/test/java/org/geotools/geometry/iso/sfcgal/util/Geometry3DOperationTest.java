...
public class Geometry3DOperationTest extends TestCase {
    ...
    public static ArrayList<Curve> getCurves(GeometryBuilder builder) {
        ...
        // 3. L1
        DirectPosition position15 = builder.createDirectPosition(new double[] { -1, -1, 2 });
        DirectPosition position16 = builder.createDirectPosition(new double[] { 0, -1, 2 });

        DirectPosition position17 = builder.createDirectPosition(new double[] { 0.5, 0, 2 });
        DirectPosition position18 = builder.createDirectPosition(new double[] { 1.5, 0, 2 });

        DirectPosition position19 = builder.createDirectPosition(new double[] { -1, -1, 3 });
        ...
        // 4. L2
        DirectPosition position23 = builder.createDirectPosition(new double[] { -1, -1, 3 });
        DirectPosition position24 = builder.createDirectPosition(new double[] { 3, -1, -1 });

        DirectPosition position25 = builder.createDirectPosition(new double[] { 0, -1, 2 });
        DirectPosition position26 = builder.createDirectPosition(new double[] { 3, -1, -1 });
        ...
        // 6. A2
        DirectPosition position35 = builder.createDirectPosition(new double[] { 1, -1, -1 });
        ...
        DirectPosition position38 = builder.createDirectPosition(new double[] { 1, -1, -1 });
        ...
        DirectPosition position46 = builder.createDirectPosition(new double[] { 3, -2.5, -1 });

        DirectPosition position47 = builder.createDirectPosition(new double[] { 0, -1, 2 });
        DirectPosition position48 = builder.createDirectPosition(new double[] { 3, -2.5, -1 });
        ...
        DirectPosition position61 = builder.createDirectPosition(new double[] { 2.5, 0.5, 3 });
        DirectPosition position62 = builder.createDirectPosition(new double[] { 0.5, -1.5, -1 });

        DirectPosition position63 = builder.createDirectPosition(new double[] { 2.5, 0.5, 3 });
        ...
        // 11. L1A1
        DirectPosition position73 = builder.createDirectPosition(new double[] { -1, -1, 2 });
        ...
        DirectPosition position77 = builder.createDirectPosition(new double[] { -1, -1, 3 });
        DirectPosition position78 = builder.createDirectPosition(new double[] { 3, -1, -1 });

        DirectPosition position79 = builder.createDirectPosition(new double[] { 0, -1, 2 });
        DirectPosition position80 = builder.createDirectPosition(new double[] { 3, -1, -1 });
        ...
        // 12. L2A1
        DirectPosition position83 = builder.createDirectPosition(new double[] { -1, -1, 2 });
        ...
        // 13. P1L1A1
        DirectPosition position89 = builder.createDirectPosition(new double[] { -0.5, -3, 2 });
        DirectPosition position90 = builder.createDirectPosition(new double[] { 1.5, 1, 2 });

        DirectPosition position91 = builder.createDirectPosition(new double[] { 0, -2, 2 });
        DirectPosition position92 = builder.createDirectPosition(new double[] { 1.5, 1, 2 });
    ...
    public static DirectPosition rotate(DirectPosition dp, double angle, double pivotX,
        ...
        double x = Math.cos(angle * Math.PI / 180) * (coordinate[0] - pivotX)
                - Math.sin(angle * Math.PI / 180) * (coordinate[1] - pivotY) + pivotX + offsetX;
        double y = Math.sin(angle * Math.PI / 180) * (coordinate[0] - pivotX)
                + Math.cos(angle * Math.PI / 180) * (coordinate[1] - pivotY) + pivotY + offsetY;
    ...
    public static ArrayList<DirectPosition> rotate(List<DirectPosition> positions, double angle,
            double pivotX, double pivotY, double offsetX, double offsetY, double offsetZ) {
        ArrayList<DirectPosition> newPositions = new ArrayList<DirectPosition>();

        for (DirectPosition dp : positions) {
            newPositions.add(rotate(dp, angle, pivotX, pivotY, offsetX, offsetY, offsetZ));
        }
    ...
    public static Curve rotate(Curve curve, double angle, double pivotX, double pivotY,
        ...
        ArrayList<DirectPosition> newPositions = rotate(((CurveImpl) curve).asDirectPositions(),
                angle, pivotX, pivotY, offsetX, offsetY, offsetZ);
    ...
    public static Surface rotate(Surface surface, double angle, double pivotX, double pivotY,
        ...
        ArrayList<DirectPosition> newPositions = rotate(
                ((RingImplUnsafe) exterior).asDirectPositions(), angle, pivotX, pivotY, offsetX,
                offsetY, offsetZ);
    ...
    public static Solid rotate(Solid solid, double angle, double pivotX, double pivotY,
        ...
        for (OrientableSurface surface : elements) {
            newElements.add(rotate((Surface) surface, angle, pivotX, pivotY, offsetX, offsetY,
                    offsetZ));
        }
