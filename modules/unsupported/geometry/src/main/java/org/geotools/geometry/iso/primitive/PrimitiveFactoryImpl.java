...
public class PrimitiveFactoryImpl implements Serializable, Factory, PrimitiveFactory {
     ...
     */
    public PointImpl createPoint(Position position) throws MismatchedReferenceSystemException,
        ...
        DirectPosition copy = positionFactory.createDirectPosition(position.getDirectPosition()
                .getCoordinate());
    ...
    public CurveBoundaryImpl createCurveBoundary(DirectPosition dp0, DirectPosition dp1) {
        ...
        return new CurveBoundaryImpl(getCoordinateReferenceSystem(), createPoint(dp0),
                createPoint(dp1));
    }
    ...
    public Ring createRing(List<OrientableCurve> orientableCurves)
        ...
        /**
         * Creates a Ring from triple Array of DirectPositions (Array of arrays, which each represent a future Curve. Each array contain an array of
     ...
     * (non-Javadoc)
     * 
     * @see org.opengis.geometry.primitive.PrimitiveFactory#createSolidBoundary(org.opengis.geometry.primitive.SolidBoundary, java.util.List)
     */
     ...
     */
    public SolidImpl createSolid(SolidBoundary boundary) throws MismatchedReferenceSystemException,
            MismatchedDimensionException {
        // TODO semantic SJ, JR
        // TODO implementation
        // TODO test
    ...
    // DirectPositionImpl maxN = (DirectPositionImpl) positionFactory.createDirectPosition(position.getCoordinate()); //new
    ...
    private PrimitiveImpl processSegmentToPrimitive(Envelope bounds, LineSegment segment,
            int dimension) {
    ...
    public Ring processBoundsToRing(Envelope bounds, LineSegment segment, final int D) {
        DirectPosition one = positionFactory.createDirectPosition(segment.getStartPoint()
                .getCoordinate()); // new DirectPositionImpl( segment.getStartPoint() );
        one.setOrdinate(D, bounds.getMinimum(D));

        DirectPosition two = positionFactory.createDirectPosition(segment.getEndPoint()
