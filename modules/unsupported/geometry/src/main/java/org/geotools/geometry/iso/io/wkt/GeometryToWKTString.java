...
public class GeometryToWKTString {
    ...
    private String ringCoordToString(Ring r) {
        ...
        String rString = directPositionToString(((Curve) orientableCurves.iterator().next())
                .getStartPoint());
    ...
    private String shellCoordToString(Shell s) {
        ...
        String rString = "(" + this.surfaceBoundaryCoordToString(((Surface) sIter.next()).getBoundary()) + ")";
        while (sIter.hasNext()) {
            if (this.lineBreak) {
                rString += "\n\t";
            }
    ...
    private String multiSurfaceCoordToString(MultiSurface mc) {
        Iterator mpIter = mc.getElements().iterator();
        String rString = "("
                + this.surfaceBoundaryCoordToString((SurfaceBoundary) ((Surface) mpIter.next())
                        .getBoundary()) + ")";
        while (mpIter.hasNext()) {
            if (this.lineBreak) {
                rString += "\n\t";
